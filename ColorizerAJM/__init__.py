...
class _ColorizerInitializer:
    ...
    def stringify_color_id(color_id: Union[int, tuple]):
        ...
        if isinstance(color_id, int):
            ...
            raise errs.InvalidColorCodeError("color_id must be an integer OR a tuple of three integers between 0 and 255")
...
__all__ = ['Colorizer', 'ColorConverter', 'errs', '_ColorizerInitializer', 'CustomColorColorizer']
